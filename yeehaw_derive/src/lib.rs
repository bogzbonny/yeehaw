...
pub fn impl_pane_basics_from(attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    fn get_start_x(&self, dr: &DrawRegion) -> i32;
    fn get_start_y(&self, dr: &DrawRegion) -> i32;
    fn get_end_x(&self, dr: &DrawRegion) -> i32;
    fn get_end_y(&self, dr: &DrawRegion) -> i32;
    fn get_dyn_start_x(&self) -> DynVal;
    fn get_dyn_start_y(&self) -> DynVal;
    fn get_dyn_end_x(&self) -> DynVal;
    fn get_dyn_end_y(&self) -> DynVal;
    fn get_height(&self, dr: &DrawRegion) -> usize;
    fn get_width(&self, dr: &DrawRegion) -> usize;
    ...
    fn get_last_size(&self) -> Ref<Size>;
    ...
    fn set_content_from_string_with_style(&self, dr: &DrawRegion, s: &str, sty: Style);
    ...
    fn set_focused(&self, focused: bool);
    fn correct_offsets_to_view_position(&self, dr: &DrawRegion, x: usize, y: usize);
}";
