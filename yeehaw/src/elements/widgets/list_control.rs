...
// TODO THE NEW LISTBOX
//  - allow for renaming on slow double click
//  - option for righthand x button for delete

// TODO new entry button
//  - probably this should just be a floating button which lives in the lower right or
//    lower left corner of the screen
//  - whichever entry has this in their line should truncate the text earlier (with ...)
//  - when it's clicked creates a new entry, which can either be autogenerated
//    or the rename chat is called for this new entry, depending on how the dev has specified
...
// TODO do not allow for duplicate names
//  - if duplicate name created, maybe automatically add (2) to the end
...
pub struct ListControlInner {
    ...
    // TODO delete, rename, duplicate, re-order down, re-order up
