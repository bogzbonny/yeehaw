...
pub fn compare_screens(
    ...
    is!(
        Bytes(&got.contents_diff(vt100_yh::Parser::default().screen())),
        Bytes(&expected.contents_diff(vt100_yh::Parser::default().screen()))
    );
...
pub fn contents_formatted_reproduces_screen(screen: &vt100_yh::Screen) -> bool {
    ...
    let mut new_parser = vt100_yh::Parser::default();
...
pub fn rows_formatted_reproduces_screen(screen: &vt100_yh::Screen) -> bool {
