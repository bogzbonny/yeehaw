...
fn check_full(vt_base: &vt100_yh::Screen, idx: usize) {
    let mut input = vec![];
    input.extend(vt_base.state_formatted());
    let mut vt_full = vt100_yh::Parser::default();
...
fn check_diff_empty(
    vt_base: &vt100_yh::Screen,
    empty: &vt100_yh::Screen,
    idx: usize,
) {
    let mut input = vec![];
    input.extend(vt_base.state_diff(empty));
    let mut vt_diff_empty = vt100_yh::Parser::default();
...
fn check_diff(
    vt_base: &vt100_yh::Screen,
    vt_diff: &mut vt100_yh::Parser,
    prev: &vt100_yh::Screen,
    idx: usize,
) {
    let mut input = vec![];
...
fn check_rows(vt_base: &vt100_yh::Screen, idx: usize) {
    let mut input = vec![];
    ...
    let mut vt_rows = vt100_yh::Parser::default();
...
fn main() {
    let mut vt_base = vt100_yh::Parser::default();
    let mut vt_diff = vt100_yh::Parser::default();
